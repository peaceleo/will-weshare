...
define('APPKEY','Aq5tSsmuwO9vpKgdutkDa8');
define('APPID','rx7zgTLDXx9z9EnftrYdN6');
define('MASTERSECRET','CJc2UBsyi66YW97nhlIus2');
define('CID','f4da055c7e9927517bfb40e2948ccc4e');
define('DEVICETOKEN','');
define('Alias','请输入别名');
...
function IGtTransmissionTemplateDemo(){
    ...
    $template->set_appkey(APPKEY);//应用appkey
    $template->set_transmissionType(1);//透传消息类型
    $template->set_transmissionContent("测试离线ddd舒服撒发生大事");//透传内容
    //$template->set_duration(BEGINTIME,ENDTIME); //设置ANDROID客户端在此时间区间内展示消息
    //APN简单推送
//        $template = new IGtAPNTemplate();
//        $apn = new IGtAPNPayload();
