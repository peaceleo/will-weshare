...
switch($_POST['action']){
      ...
      case 'needpublish':
            ...
            $needpay=$_POST['needpay'];
             $sql="INSERT INTO needlist(id,label,usertel,needtime,needlocation,remark,publishtime,user,status,needpay,needpic) 
            VALUES(null,'$label','$usertel',null,'$userlocation','$remark','$publishtime','$user','0','$needpay','$pic')";
